...
if __name__ == "__main__":
	...
	print(f"{student_pass.name} średnia = {student_pass.average():.2f}, zdane? {student_pass.is_passed()}")
	print(f"{student_fail.name} średnia = {student_fail.average():.2f}, passed? {student_fail.is_passed()}")

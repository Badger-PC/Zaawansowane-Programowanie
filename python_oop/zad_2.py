...
class Employee:
    ...
    def __str__(self):
        return (
            f"Pracownik(imie={self.first_name}, nazwisko={self.last_name}, "
            f"data_zatrudnienia={self.hire_date}, data_urodzenia={self.birth_date}, "
            f"miasto={self.city}, ulica={self.street}, kod_pocztowy={self.zip_code}, "
...
class Book:
    ...
    def __str__(self):
        ...
        return (
            f"Książka(tytuł={self.title or 'Nieznany/Księga Gada Jasnowidza'}{title_part}, "
            f"data_wydania={self.publication_date}, autor={self.author_name} {self.author_surname}, "
            f"liczba_stron={self.number_of_pages}, biblioteka={lib_str})"
        )
...
book2 = Book(
    ...
    "Borczuk",
    210,
    title="Historia Polski od 1918 p..n.e. do dziś",
)
book3 = Book(
    lib2,
    "2015-07-07",
    ...
    "Borczuk",
    150,
    title="Podstawy matematyki oraz fizyka kwantowa",
)
book4 = Book(
    lib2,
    "2020-02-02",
    ...
    "Borczuk",
    480,
    title="Nowoczesne programowanie w Asemblerze",
)
book5 = Book(
    lib1, "2010-10-10", "Macus", "Borczuk", 95, title="Literatura piękna i brzydka"
)
